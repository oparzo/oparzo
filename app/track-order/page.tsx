...
export default function TrackOrderPage() {
  ...
  return (
    <main className="max-w-6xl mx-auto px-6 py-16">
      ...
      <h1 className="mt-4 text-5xl font-serif">Track Your Order</h1>

      <form onSubmit={searchOrder} className="mt-10 space-y-6">
        <input
          required
          value={orderNumber}
      ...
      {order && (
        <div className="mt-12 rounded-2xl border bg-[var(--cream)] p-8">
          <h2 className="text-3xl font-serif">{order.order_number}</h2>
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-2 text-xl">{order.payment_method}</p>
            </div>
          ...
          <h3 className="mt-12 mb-6 text-2xl font-serif">Ordered Items</h3>
